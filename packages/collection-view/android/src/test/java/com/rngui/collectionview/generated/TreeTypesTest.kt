...
class TreeTypesTest {
  ...
  fun everyFieldRoundTrips() {
    ...
    assertEquals(176.0, decoded.appearance?.firstSectionSpacing)
    assertEquals("Tree.appearance.font.family", decoded.appearance?.font?.family)
    assertEquals(187.0, decoded.appearance?.font?.size)
    ...
    assertEquals(198.0, decoded.appearance?.headerFont?.size)
    ...
    assertEquals(209.0, decoded.appearance?.footerFont?.size)
    ...
    assertEquals(220.0, decoded.darkAppearance?.backgroundGradient?.locations?.get(0))
    assertEquals(231.0, decoded.darkAppearance?.backgroundGradient?.angle)
    ...
    assertEquals(242.0, decoded.darkAppearance?.sectionSpacing)
    assertEquals(253.0, decoded.darkAppearance?.firstSectionSpacing)
    assertEquals("Tree.darkAppearance.font.family", decoded.darkAppearance?.font?.family)
    assertEquals(264.0, decoded.darkAppearance?.font?.size)
    ...
    assertEquals(275.0, decoded.darkAppearance?.headerFont?.size)
    ...
    assertEquals(286.0, decoded.darkAppearance?.footerFont?.size)
