...
class TreeTypesTest {
  ...
  fun everyFieldRoundTrips() {
    ...
    assertEquals(110.0, decoded.appearance?.backgroundGradient?.angle)
    ...
    assertEquals(121.0, decoded.appearance?.sectionSpacing)
    ...
    assertEquals(132.0, decoded.appearance?.font?.size)
    ...
    assertEquals(143.0, decoded.appearance?.headerFont?.size)
    ...
    assertEquals(154.0, decoded.appearance?.footerFont?.size)
    ...
    assertEquals(165.0, decoded.darkAppearance?.backgroundGradient?.locations?.get(0))
    assertEquals(176.0, decoded.darkAppearance?.backgroundGradient?.angle)
    ...
    assertEquals(187.0, decoded.darkAppearance?.sectionSpacing)
    ...
    assertEquals(198.0, decoded.darkAppearance?.font?.size)
    ...
    assertEquals(209.0, decoded.darkAppearance?.headerFont?.size)
    ...
    assertEquals(220.0, decoded.darkAppearance?.footerFont?.size)
