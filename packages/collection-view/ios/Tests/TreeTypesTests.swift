...
final class TreeTypesTests: XCTestCase {
  ...
  func testEveryFieldRoundTrips() throws {
    ...
    XCTAssertEqual(decoded.appearance?.backgroundGradient?.locations?.first, 88)
    XCTAssertEqual(decoded.appearance?.backgroundGradient?.angle, 99)
    ...
    XCTAssertEqual(decoded.appearance?.sectionSpacing, 110)
    ...
    XCTAssertEqual(decoded.appearance?.font?.size, 121)
    ...
    XCTAssertEqual(decoded.appearance?.headerFont?.size, 132)
    ...
    XCTAssertEqual(decoded.appearance?.footerFont?.size, 143)
    ...
    XCTAssertEqual(decoded.darkAppearance?.backgroundGradient?.locations?.first, 154)
    XCTAssertEqual(decoded.darkAppearance?.backgroundGradient?.angle, 165)
    ...
    XCTAssertEqual(decoded.darkAppearance?.sectionSpacing, 176)
    ...
    XCTAssertEqual(decoded.darkAppearance?.font?.size, 187)
    ...
    XCTAssertEqual(decoded.darkAppearance?.headerFont?.size, 198)
    ...
    XCTAssertEqual(decoded.darkAppearance?.footerFont?.size, 209)
